var wcag_criteria_list = [
`Criterion 1.1.1 Non-text Content (Level A): Images have equivalent alt text. Decorative images that do not convey information have a null (alt="") alt attribute. Form inputs have labels.`,
